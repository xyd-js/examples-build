...
export const tagsBySlug: Record<string, string[]> = {
  ...
  "i18n-catalog-overrides": ["Internationalization"],
  "i18n-catalogs": ["Internationalization"],
  "i18n-catalogs-custom-paths": ["Internationalization"],
  "i18n-overrides": ["Internationalization"],
  "i18n-overrides-flat": ["Internationalization"],
  mcp: ["MCP", "AI"],
